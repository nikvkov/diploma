...
<div class="row">
    <div class="col-md-6 cta-button">
        <button onclick="previewGMCFile()" class="btn btn-lg btn-block btn-info">Предварительный просмотр файла</button>
    </div>
    <div class="col-md-6 cta-button">
                    ...
                    <thead class="thead-inverse">
                        <tr >
                            <th class="text-center"><form role='form' class='form-inline'><div class='form-group'>
                                ...
                                <label>
                                <input checked   onchange='checkAllProductGMC()' id = 'allCheckInTable' type="checkbox" name="allCheckInTable" > <span class="label-text"></span>
                                </label>
                                </div>
                                </div></form>
                            </th>
