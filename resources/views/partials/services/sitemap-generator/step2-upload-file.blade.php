<div class="row">
    ...
    <div class="col-md-9 cta-contents">
        <h1 class="cta-title">Шаг 2 : Загрузите файл с ссылками</h1>
        <div class="cta-desc">
...
<!--        <input  type="button" class="btn btn-lg btn-block btn-info" value="Начать проверку" />-->
        <button type="submit" name="submit" class="btn btn-lg btn-block btn-info" >Далее</button>
    </div>
...
<script>
    ...
    //  event.stopPropagation(); // остановка всех текущих JS событий
        ...
        ajaxLoadFilesForSitemap(formData);
    });
</script>