                ...
                <div style="display: none" id="order_data_file" class="col-sm-8 col-md-8">
                    <div class="alert-message alert-message-notice">
                        ...
                        <table style="margin-top: 25px" class="table table-bordered">
                            ...
                            <th><button class="btn btn-outline-info btn-oblong tx-11 tx-uppercase tx-mont tx-medium tx-spacing-1 pd-x-30 bd-2" onclick="statisticExistOrders()">Отчет</button></th>
                            </tr>
                            </thead>
                            ...
                            <tr class ="t_row">
                                ...
                                <td class="text text-md-center">@if($file->project_id==0) Все @else{{$file->project->title}}@endif</td>
                                <td class="text text-md-center">@if($file->service_id==0) Все @else{{$file->service->title}}@endif</td>
