...
<div style="margin-top: 20px" class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="accordion.html" class="nav-link">Все сообщения</a></li>
            <li class="nav-item"><a href="alerts.html" class="nav-link">Отправить новое сообщение</a></li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="accordion.html" class="nav-link">Архив</a></li>
            <li class="nav-item"><a href="alerts.html" class="nav-link">Новая рассылка</a></li>
        </ul>
        ...
        <ul class="br-menu-sub nav flex-column">
            <li class="nav-item"><a href="accordion.html" class="nav-link">Архив</a></li>
            <li class="nav-item"><a href="alerts.html" class="nav-link">Статистика</a></li>
        </ul>
        ...
        <div class="row row-sm mg-t-20">
            <div class="col-8">
                ...
                <div class="card bd-0 shadow-base pd-30 mg-t-20">
                    <div class="d-flex align-items-center justify-content-between mg-b-30">
                        ...
                        <a href="" class="btn btn-outline-info btn-oblong tx-11 tx-uppercase tx-mont tx-medium tx-spacing-1 pd-x-30 bd-2">Подробнее</a>
                    </div><!-- d-flex -->
            ...
            <div class="col-4">
                ...
                <div class="card bd-0 shadow-base pd-30">
                    <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Статус создания</h6>
                    <p class="mg-b-25">Статистика заполнения данных</p>

                    <label class="tx-12 tx-gray-600 mg-b-10">Пользователи</label>
